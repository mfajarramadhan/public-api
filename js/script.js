    ...
    success: function (result) {
      if (result.Response == "True") {
        ...
        $.each(movies, function (i, data) {
          $("#movie-list").append(`
              <div class="sm:w-1/2 xl:w-1/3 bg-white flex justify-center">
          <div
                      class="w-full my-4 max-w-xs bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700"
                    >
                      <a href="#">
                        <img class="w-full h-80 rounded-t-lg" src="${data.Poster}" alt="" />
                      </a>
                      <div class="p-5">
                        <a href="#">
                          <h5
